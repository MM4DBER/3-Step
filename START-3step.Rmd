...
### This script file `START-3step.Rmd` includes omitted code. The intention for this activity is to have trainees fill in the missing code while following along with the video. Sections with omitted code are places in the syntax that will vary based on research context. To check your results compare with script file `FINISH-3step.Rmd`.
